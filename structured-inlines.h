...
DEF_PUSH_INT(int, uid_1, s_umove_verbose)
DEF_PUSH_INT(int, gid_1, s_umove_verbose)
DEF_PUSH_INT(short, uid16_1, s_umove_verbose)
DEF_PUSH_INT(short, gid16_1, s_umove_verbose)
...
DEF_XLAT(int, signed, xlat_d, umove)
